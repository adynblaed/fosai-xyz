...
| ggerganov's llamacpp | 🤖 Text-based AI/LLM Software | [Link](https://github.com/ggerganov/llama.cpp) |
| LM Studio | 🤖 Text-based AI/LLM Software | [Link](https://lmstudio.ai) |
...
| Replicate | 🤖 Text-based AI AI/LLM Software | [Link](https://replicate.com/) |
